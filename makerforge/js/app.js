...
import { meshToStl, downloadBlob, filenameFor, sanitizeMeshForStl, prepareMeshFor3mf, baseModelName, countOpenEdges } from "./stl.js?v=198";
...
import {
  ...
  fetchDesignParams,
  deleteLibraryDesign,
} from "./library.js?v=198";

const SESSION_KEY = "makerdeck-session-v1";
const MAKERDECK_BUILD = "b198";
