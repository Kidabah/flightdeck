...
import {
  ...
  fetchDesignParams,
  deleteLibraryDesign,
} from "./library.js?v=185";

const SESSION_KEY = "makerdeck-session-v1";
const MAKERDECK_BUILD = "b185";
