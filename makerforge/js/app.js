...
import { ensureHoodieStubbyMesh } from "./hoodie-stubby.js?v=596";
import {
  MAX_ACCENT_BANDS,
  newAccentBand,
...
function syncEmbossFaceUi() {
  ...
  if (hint) {
    if (hoodie && face === "front") {
      ...
      hint.textContent = "Same Text box — letters wrap around the back. Chest logo stays on the front.";
      hint.classList.remove("hidden");
