const GRAPH = {
  "nodes": [
    ...
    },
    {
      ...
      "excerpt": "# Amy sleep + idle After ~3 minutes quiet she **yawns** (real WAV) and nudges you that she’s getting sleepy. After ~6 minutes she enters **sleep** — circle goes dark. Or tuck her in anytime: **bedtime** / **goodnight** / **night night** / **go to sleep** → she says goodnight, yawns, and sleeps. Wake her with **wake up Amy**, **hey Amy**, click her face, or MIC/ASK. Ask her to **whistle** or **sing** anytime (voice or type) and she plays a real whistle melody (`viewer/sounds/amy-whistle.wav`). SFX lives in `jarvis/viewer/sounds/`: - `amy-whistle.wav` — on-demand whistle/sing - `amy-yawn.wav` — idle sleepy nudge + bedtime - `amy-sleep.gif` — optional lights-out overlay (CSS iris + Zzz if miss…"
    },
    {
      "id": 6,
      "label": "amy voice",
