const GRAPH = {
  "nodes": [
    ...
    },
    {
      ...
      "excerpt": "# Amy sleep + idle After ~3 minutes quiet she may whistle a little tune and nudge you. After ~6 minutes she enters **sleep** — circle goes dark. Wake her with **wake up Amy**, **hey Amy**, click her face, or MIC/ASK. Ask her to **whistle** or **sing** anytime (voice or type) and she plays the tune on demand. While she's talking: say **stop** / **wait** / **hang on**, type it, or hit **STOP**. Mic can stay on while she sleeps so the wake phrase works."
    },
    {
      "id": 6,
      "label": "amy voice",
